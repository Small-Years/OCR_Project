...
-(UIButton *)centerBtn{
    if (_centerBtn == nil) {
        _centerBtn = [[UIButton alloc]initWithFrame:CGRectMake(0, settingBtn.y,settingBtn.width , settingBtn.height)];
...
//    [self.view addSubview:startBtn];
    ...
    lightBtn = [[UIButton alloc]initWithFrame:CGRectMake(SCREEN_WIDTH - 80, SCREEN_HEIGHT - 100, 60, 60)];
